...
trainId_author = pd.DataFrame(pd.read_csv('data/trainId_author.txt', names = ['author']))
testId_author = pd.DataFrame(pd.read_csv('data/testId_author.txt', names = ['author']))
trainId_paper = pd.DataFrame(pd.read_csv('data/trainId_paper.txt', names = ['paper']))
testId_paper = pd.DataFrame(pd.read_csv('data/testId_paper.txt', names = ['paper']))

author_label = pd.DataFrame(pd.read_csv('data/author_label.txt', names = ['author', 'label'], sep = "	"))
paper_label = pd.DataFrame(pd.read_csv('data/paper_label.txt', names = ['paper', 'label'], sep = "	"))
conf_label = pd.DataFrame(pd.read_csv('data/conf_label.txt', names = ['conference', 'label'], sep = "	"))

paper_author_with1 = pd.DataFrame(pd.read_csv('data/PA.txt', names = ['paper' , 'author', '1'], sep="	"))
paper_author = paper_author_with1.drop(['1'], axis=1)
paper_conference_with1 = pd.DataFrame(pd.read_csv('data/PC.txt', names = ['paper' , 'conference', '1'], sep="	"))
paper_conference = paper_conference_with1.drop(['1'], axis=1)
paper_term_with1 = pd.DataFrame(pd.read_csv('data/PT.txt', names = ['paper' , 'term', '1'], sep="	"))
