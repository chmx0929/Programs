...
def APVPA(name):
	...
	data = pd.read_csv('data/PA.txt', names = ['paper' , 'author', '1'], sep="	")
	paper_author_with1 = pd.DataFrame(data)
	paper_author = paper_author_with1.drop(['1'], axis=1)
	data = pd.read_csv('data/PC.txt', names = ['paper' , 'conference', '1'], sep="	")
...
def APTPA(name):
	...
	paper_author_with1 = pd.DataFrame(data)
	paper_author = paper_author_with1.drop(['1'], axis=1)
	data = pd.read_csv('data/PT.txt', names = ['paper' , 'term', '1'], sep="	")
